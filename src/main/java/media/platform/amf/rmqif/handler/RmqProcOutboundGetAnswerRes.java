...
/**
 * Acs AMF
 * @file RmqProcOutboundGetAnswerRes.java
 * @author Tony Lim
 *
 */
...
public class RmqProcOutboundGetAnswerRes extends RmqOutgoingMessage {

    private static final Logger logger = LoggerFactory.getLogger( RmqProcOutboundGetAnswerRes.class);

    public RmqProcOutboundGetAnswerRes(String sessionId, String transactionId) {
        super(sessionId, transactionId);
        setType(RmqMessageType.RMQ_MSG_STR_OUTBOUND_SET_ANSWER_RES);
    }
