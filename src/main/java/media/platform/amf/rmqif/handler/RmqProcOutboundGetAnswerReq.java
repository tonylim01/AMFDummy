...
/**
 * Acs AMF
 * @file RmqProcOutboundGetAnswerReq.java
 * @author Tony Lim
 *
 */
...
public class RmqProcOutboundGetAnswerReq extends RmqIncomingMessageHandler {

    private static final Logger logger = LoggerFactory.getLogger( RmqProcOutboundGetAnswerReq.class);
    ...
    public boolean handle(RmqMessage msg) {
        ...
        logger.info("[{}] OutboundGetAnswerReq", msg.getSessionId());
...
//        allocLocalResource(sessionInfo);
    ...
    public void sendResponse(String sessionId, String transactionId, String queueName, int reasonCode, String reasonStr) {
        ...
        RmqProcOutboundGetAnswerRes res = new RmqProcOutboundGetAnswerRes(sessionId, transactionId);
